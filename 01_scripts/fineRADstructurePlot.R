...
setwd("~/Documents/01_moore_oyster_project/stacks_workflow_no_Qc/08-fineRADstructure") ## The directory where the files are located
...
analysisName <- "batch_1";  maxIndv <- 10000; maxPop<-10000
...
# this is a very large, unwieldy XMLDocument
...
## NOTE: if your population labels don't correspond to the format we used (NAME<number>) 
## YOU MAY HAVE TROUBLE HERE. YOU MAY NEED TO RENAME THEM INTO THIS FORM AND DEFINE YOUR POPULATION NAMES IN popnamesplot BELOW
